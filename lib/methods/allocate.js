...
allocate.prototype.allocate = function(msg, reply) {
  ...
  if (msg.getAttribute('reservation-token')) {
    ...
    allocatedSockets = new Promise(function(resolve) {
...
allocate.prototype.allocateUdp = function(msg) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    random(function(err, rand) {
      ...
      var ip = new Address(self.getRelayIp(msg), next_ephemeral);
      var family = ip.family === CONSTANTS.TRANSPORT.FAMILY.IPV4 ? 'udp4' : 'udp6';
...
allocate.prototype.allocateUdpEven = function(msg, evenPortRBit) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var ip = new Address(self.getRelayIp(msg), port1);
    var family = ip.family === CONSTANTS.TRANSPORT.FAMILY.IPV4 ? 'udp4' : 'udp6';
    const udpSocket1 = dgram.createSocket(family);
    ...
    if (evenPortRBit) {
      ...
      const udpSocket2 = dgram.createSocket(family);
